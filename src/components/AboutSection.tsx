    ...
    <div className="max-w-3xl mx-auto">
      ...
      <ScrollReveal delay={0.15}>
        <p className="font-body text-lg text-muted-foreground leading-relaxed mb-6">
          I'm a UI/UX designer with over 2 years of experience crafting digital products for startups and enterprise teams. I believe that great design sits at the intersection of empathy, clarity, and craft  solving real problems while creating moments of delight.
